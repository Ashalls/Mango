...
interface ConnectionDialogProps {
  onClose: () => void
  editProfile?: { id: string; name: string; uri: string; color?: string; isProduction?: boolean; claudeAccess?: 'readonly' | 'readwrite' }
}
          ...
          <div className="rounded-md border border-border px-3 py-2.5">
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                <div className="mt-0.5 text-[10px] opacity-75">Claude can query but not modify data</div>
              </button>
              <button
                className={`flex-1 rounded-md border px-3 py-2 text-xs ${
                ...
                onClick={() => setClaudeAccess('readwrite')}
              >
